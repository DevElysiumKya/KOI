...
class Koi {
    ...
    constructor(x,y) {
        ...
        this.a = 0;
        this.A = 0;
        this.c0 = 250 + (random()*40);
        this.c1 = `hsl(${this.c0},100%,40%)`
        this.c2 = `hsl(70,30%,90%)`        
    }
...
const init = () => {
    ...
    c.width = W = 1600;
    san = c.getContext('2d');  
    for(let i=0;i<14;i++) koi.push(new Koi(200, 100+i*100));
    c.ontouchmove = M;
    Loop();
};
onload = init;